...
def make_wind():
    ...
    table_wind = power_unit_wind \
        .merge(unit_wind, on='EinheitMastrNummer', how='left', suffixes=('', '_w')) \
        .merge(unit_wind_eeg, on='EegMastrNummer', how='left', suffixes=('', '_e'))
    #\
     #   .merge(unit_wind_permit, on='GenMastrNummer', how='left', suffixes=('', '_p'))
        ...
        #       on='GenMastrNummer', how='inner', rsuffix='_p')
